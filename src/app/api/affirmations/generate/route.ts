...
- Specific to the activity mode and the member existential profile
    ...
    if (ELEVENLABS_API_KEY) {
      ...
      try {
        ...
        if (ttsRes.ok) {
          ...
          if (!uploadErr) {
            // ECQO SAFE SOURCE CODE: Clinical-grade signed URL (24h expiry)
            // Bucket is PRIVATE. HIPAA / EU AI Act / SAMHSA compliant.
