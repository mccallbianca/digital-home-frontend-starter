      ...
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <div style={{ background: '#FFFFFF', borderRadius: 16, padding: 24, boxShadow: '0 2px 12px rgba(0,0,0,0.06)', marginBottom: 24 }}>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <Link href="/dashboard/modes" style={{ fontSize: '1rem', color: '#C42D8E', textDecoration: 'underline' }}>Change Modes</Link>
            <Link href="/dashboard/genres" style={{ fontSize: '1rem', color: '#C42D8E', textDecoration: 'underline' }}>Change Genres</Link>
          </div>
        </div>
        ...
        {modes.length > 0 ? modes.map((mode: string) => (
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
              <div style={{
                width: 48, height: 48, borderRadius: '50%', background: 'rgba(196,45,142,0.15)',
                display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
              }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="#C42D8E"><path d="M8 5v14l11-7z" /></svg>
              </div>
              <div style={{ flex: 1 }}>
