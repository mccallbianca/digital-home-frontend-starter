    ...
    >
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        {!isLocked && (
          ...
          >
            <p style={{ fontSize: 14, color: 'rgba(26,15,26,0.5)' }}>
        ...
        {isLocked && (
          ...
          >
            ...
            <p style={{ fontSize: 15, color: 'rgba(26,15,26,0.6)', marginBottom: 24 }}>
            ...
            return (
              ...
              >
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke={isSelected ? '#C42D8E' : 'rgba(26,15,26,0.4)'}
                  strokeWidth="1.5"
                  strokeLinecap="round"
                ...
                <p style={{ fontSize: 13, color: 'rgba(26,15,26,0.5)', lineHeight: 1.4 }}>
                  {mode.desc}
                </p>
              </button>
            );
