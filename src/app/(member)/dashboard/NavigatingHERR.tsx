  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-lg mx-6 animate-fade-up">
          ...
          {TUTORIAL_STEPS.map((_, i) => (
            <div
              ...
              className={`h-1.5 rounded-full transition-all duration-300 ${
                i === step
                  ? 'w-8 bg-[var(--herr-magenta)]'
                  : i < step
                    ? 'w-1.5 bg-[var(--herr-magenta)] opacity-40'
                    : 'w-1.5 bg-[rgba(26,15,26,0.4)]'
              }`}
            />
          ))}
        </div>
        ...
        {/* Content card */}
        <div className="bg-[#FFFFFF] border border-[rgba(26,15,26,0.08)] p-10">
          {/* Welcome header (only on first step) */}
          {step === 0 && (
            <div className="mb-8">
              <p className="herr-label text-[var(--herr-magenta)] mb-3">Navigating HERR</p>
              <h2 className="font-display text-3xl font-light text-[var(--herr-ink)] mb-2">
                Welcome to your Dashboard.
              </h2>
              <p className="text-[rgba(26,15,26,0.6)] text-sm leading-relaxed">
          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              <h3 className="font-display text-xl font-light text-[var(--herr-ink)] mb-2">
                {current.title}
              </h3>
              <p className="text-[0.88rem] text-[rgba(26,15,26,0.6)] leading-relaxed">
                {current.description}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between mt-10">
            <button
              ...
              className="text-[0.75rem] text-[rgba(26,15,26,0.4)] hover:text-[rgba(26,15,26,0.6)] transition-colors uppercase tracking-widest"
            >
              Skip Tour
            </button>
            ...
            <div className="flex items-center gap-4">
              {step > 0 && (
                <button
                  ...
                  className="text-[0.75rem] text-[rgba(26,15,26,0.6)] hover:text-[var(--herr-ink)] transition-colors uppercase tracking-widest"
                >
                  Back
                </button>
              )}
        ...
        {/* Step count */}
        <p className="text-center mt-4 text-[0.68rem] text-[rgba(26,15,26,0.4)]">
