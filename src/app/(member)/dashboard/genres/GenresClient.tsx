  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--herr-cream)', padding: '80px 24px 60px' }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <p style={{ fontSize: 16, color: 'rgba(26,15,26,0.6)', textAlign: 'center', marginBottom: 32 }}>
          Select up to 2 genres per week. Your sonic architecture will be calibrated to your selection.
        </p>

        {!isLocked && (
          <div style={{ background: '#FFFFFF', borderRadius: 12, padding: '16px 24px', marginBottom: 32, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <p style={{ fontSize: 14, color: 'rgba(26,15,26,0.5)' }}>Max 2 genres per week.</p>
            <p style={{ fontSize: 14, color: '#C42D8E' }}>{selected.length} of {maxGenres} selected</p>
          </div>
        )}

        {isLocked && (
          <div style={{ background: '#FFFFFF', borderRadius: 16, padding: 40, border: '1px solid rgba(26,15,26,0.08)', textAlign: 'center', marginBottom: 32 }}>
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="rgba(26,15,26,0.3)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ margin: '0 auto 16px', display: 'block' }}>
            ...
            <p style={{ fontSize: 15, color: 'rgba(26,15,26,0.6)', marginBottom: 24 }}>Upgrade to Personalized to choose your genres.</p>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  borderRadius: 16,
                  padding: 0,
                  border: isSelected ? '2px solid #C42D8E' : '1px solid rgba(26,15,26,0.08)',
              ...
              >
                ...
                <div style={{ padding: '16px 20px' }}>
                  ...
                  <p style={{ fontSize: 13, color: 'rgba(26,15,26,0.5)' }}>{genre.desc}</p>
                </div>
              </button>
            );
          })}
        ...
        <p style={{ fontSize: 13, color: 'rgba(26,15,26,0.4)', fontStyle: 'italic', textAlign: 'center', marginTop: 16 }}>
