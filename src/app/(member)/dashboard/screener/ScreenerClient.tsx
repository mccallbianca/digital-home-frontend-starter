  ...
  return (
    ...
    >
      ...
      {showCrisis && (
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 16, color: 'rgba(26,15,26,0.7)', marginBottom: 8 }}>
              You are not alone.
            </p>
            <p style={{ fontSize: 15, color: '#E8388A', fontWeight: 600, marginBottom: 4 }}>
              If you are in crisis, please call or text 988
            </p>
            <p style={{ fontSize: 14, color: 'rgba(26,15,26,0.5)', marginBottom: 4 }}>
              Suicide &amp; Crisis Lifeline
            </p>
            <p style={{ fontSize: 14, color: 'rgba(26,15,26,0.5)', marginBottom: 24 }}>
            ...
            <button
              ...
              style={{
                ...
                color: '#FFFFFF',
                borderRadius: 12,
                border: '1px solid rgba(26,15,26,0.3)',
                fontSize: 14,
                fontWeight: 600,
      ...
      <div style={{ maxWidth: 640, width: '100%', textAlign: 'center', marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 14, color: 'rgba(26,15,26,0.5)', marginBottom: 16 }}>
        ...
        {current === 0 && (
          <p style={{ fontSize: 13, color: 'rgba(26,15,26,0.4)', marginTop: 16, fontStyle: 'italic' }}>
      ...
      >
          ...
          {LIKERT.map((opt) => (
            <button
              ...
              style={{
                ...
                height: 64,
                borderRadius: 12,
                border: selected === opt.value ? '2px solid #C42D8E' : '1px solid rgba(26,15,26,0.15)',
                background: selected === opt.value ? '#C42D8E' : '#FFFFFF',
                color: selected === opt.value ? '#FFFFFF' : 'rgba(26,15,26,0.6)',
                fontSize: 20,
                fontWeight: 600,
                cursor: 'pointer',
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0 4px' }}>
          <span style={{ fontSize: 11, color: 'rgba(26,15,26,0.4)' }}>Not at all</span>
          <span style={{ fontSize: 11, color: 'rgba(26,15,26,0.4)' }}>Very much</span>
        </div>
      </div>
      ...
      >
        <button
          ...
          style={{
            ...
            padding: '0 32px',
            background: 'transparent',
            color: current === 0 ? 'rgba(26,15,26,0.2)' : '#FFFFFF',
            borderRadius: 12,
            border: '1px solid',
            borderColor: current === 0 ? 'rgba(26,15,26,0.1)' : 'rgba(26,15,26,0.3)',
            fontSize: 14,
            fontWeight: 600,
            textTransform: 'uppercase',
            letterSpacing: '1px',
