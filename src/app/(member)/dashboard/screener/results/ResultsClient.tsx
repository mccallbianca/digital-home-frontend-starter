      ...
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: 24, color: 'rgba(26,15,26,0.4)' }}>/ 5.0</span>
          </p>
          <p style={{ fontSize: 16, color: '#E8388A', marginBottom: 16 }}>
            {getOverallLabel(overallAvg)}
          </p>
          <p style={{ fontSize: 14, color: 'rgba(26,15,26,0.6)', lineHeight: 1.6, maxWidth: 520, margin: '0 auto' }}>
        ...
        <div className="domain-grid">
          {scores.map((s, i) => (
            ...
            >
              ...
              <p style={{ fontSize: 13, color: 'rgba(26,15,26,0.5)' }}>
        ...
        >
          ...
          {[
            ...
            <div key={i} style={{ display: 'flex', gap: 16, marginBottom: i < 2 ? 20 : 0 }}>
              ...
              <p style={{ fontSize: 15, color: 'rgba(26,15,26,0.7)', lineHeight: 1.6 }}>
                {text}
              </p>
            </div>
          ))}
        ...
        {/* Historical results */}
        {snapshots.length > 0 && (
          <div style={{ marginTop: 48, borderTop: '1px solid rgba(26,15,26,0.08)', paddingTop: 32 }}>
            <p
              style={{
                fontSize: 12,
                textTransform: 'uppercase',
                letterSpacing: '2px',
                color: 'rgba(26,15,26,0.4)',
                marginBottom: 16,
              }}
            >
              ...
              return (
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <span style={{ fontSize: 14, color: 'rgba(26,15,26,0.5)' }}>{avg} / 5.0</span>
                  </div>
                </div>
              );
            })}
        ...
        >
          ...
          <a href="tel:988" style={{ color: 'rgba(26,15,26,0.5)', textDecoration: 'underline' }}>988</a>.
        </p>
      </div>
