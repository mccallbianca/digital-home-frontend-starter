...
export default async function ECQOSoundDashboardPage() {
  ...
  return (
    <main className="min-h-screen">
      <section className="px-6 pt-32 pb-16 border-b border-[rgba(26,15,26,0.08)]">
        <div className="max-w-[900px] mx-auto">
          ...
          <p className="herr-label text-[var(--herr-magenta)] mb-4">ECQO Sound</p>
          <h1 className="font-display text-4xl md:text-6xl font-light text-[var(--herr-ink)] leading-[0.9] mb-6">
            Your healing has<br />
            <span className="text-[var(--herr-magenta)]">a soundtrack.</span>
          </h1>
