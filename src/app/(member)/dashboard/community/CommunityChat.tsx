    ...
    return (
      <div className="flex items-center justify-center py-24">
        <div className="text-center">
          <div className="w-8 h-8 border-2 border-[var(--herr-magenta)] border-t-transparent rounded-full animate-spin mx-auto mb-4" />
          <p className="text-[rgba(26,15,26,0.6)]">Connecting to HERR Nation…</p>
        </div>
      </div>
    );
  }
  ...
  if (error || !client) {
    return (
      <div className="border border-[rgba(26,15,26,0.08)] border-l-2 border-l-[var(--herr-magenta)] p-8">
        <p className="herr-label text-[var(--herr-magenta)] mb-3">Connection Error</p>
