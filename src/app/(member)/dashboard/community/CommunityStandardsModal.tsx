...
export default function CommunityStandardsModal({ onAccept }: CommunityStandardsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm px-4">
      <div className="bg-[var(--herr-cream)] border border-[rgba(26,15,26,0.08)] max-w-2xl w-full max-h-[85vh] overflow-y-auto p-8">
        <p className="herr-label text-[var(--herr-magenta)] mb-4">Before You Enter</p>
        <h2 className="font-display text-3xl font-light text-[var(--herr-ink)] mb-6">
          HERR Nation<br />
          <span className="text-[var(--herr-magenta)]">Community Standards.</span>
        </h2>

        <div className="space-y-6 text-[0.88rem] text-[rgba(26,15,26,0.6)] leading-relaxed">
          {/* 988 Crisis Block — persistent */}
          <div className="bg-[#1a0a12] border border-[var(--herr-magenta)] p-5">
            <p className="herr-label text-[var(--herr-magenta)] mb-2">If You Are in Crisis</p>
            <p>
              If you or someone you know is in immediate danger, please contact the{' '}
              <strong className="text-[var(--herr-ink)]">988 Suicide & Crisis Lifeline</strong>{' '}
              by calling or texting <strong className="text-[var(--herr-ink)]">988</strong>.
            </p>
            <p className="mt-2">
          ...
          <div>
            <h3 className="text-[var(--herr-ink)] font-medium mb-2">1. Respect Every Version of HERR</h3>
            <p>
          ...
          <div>
            <h3 className="text-[var(--herr-ink)] font-medium mb-2">2. Anti-Discrimination</h3>
            <p>
          ...
          <div>
            <h3 className="text-[var(--herr-ink)] font-medium mb-2">3. Anti-Harassment</h3>
            <p>
          ...
          <div>
            <h3 className="text-[var(--herr-ink)] font-medium mb-2">4. No Clinical Advice</h3>
            <p>
          ...
          <div>
            <h3 className="text-[var(--herr-ink)] font-medium mb-2">5. Confidentiality</h3>
            <p>
          ...
          <div>
            <h3 className="text-[var(--herr-ink)] font-medium mb-2">6. Safety & Moderation</h3>
            <p>
        ...
        <div className="mt-8 border-t border-[rgba(26,15,26,0.08)] pt-6">
          <label className="flex items-start gap-3 cursor-pointer group">
            ...
            />
            <span className="text-[0.85rem] text-[rgba(26,15,26,0.6)] group-hover:text-[var(--herr-ink)] transition-colors">
