...
export default async function CommunityPage() {
  ...
  return (
    <main style={{ minHeight: '100vh' }}>
      ...
      <section style={{ background: 'var(--herr-cream)', padding: '64px 24px' }}>
          ...
          <ScrollFadeIn>
            ...
            >
              ...
              >
                ...
                <p style={{ fontSize: '1rem', color: 'var(--herr-cream)', lineHeight: 1.6, marginBottom: 16 }}>
              ...
              >
                ...
                <p style={{ fontSize: '1rem', color: 'rgba(26,15,26,0.5)', marginBottom: 6 }}>
                  We&apos;re exploring: <span style={{ color: 'var(--herr-cream)', fontWeight: 600 }}>{theme.concern}</span>
                </p>
                <p
                  style={{
                    fontFamily: "'Cormorant Garamond', Georgia, serif",
              ...
              >
                ...
                <p style={{ fontSize: '1rem', color: 'var(--herr-cream)', lineHeight: 1.6 }}>
                  Welcome to the first generation of HERR pioneers.
                  You are building this community from the ground up.
                </p>
                <p style={{ fontSize: 13, color: 'rgba(26,15,26,0.4)', marginTop: 12 }}>
      ...
      <section style={{ background: 'var(--herr-cream)', padding: '48px 24px' }}>
      ...
      {/* ── CTA Banner (dark) ──────────────────────────────────── */}
      <section style={{ background: 'var(--herr-cream)', padding: '32px 24px', textAlign: 'center' }}>
        <ScrollFadeIn>
          <p
            style={{
              fontSize: '1rem',
