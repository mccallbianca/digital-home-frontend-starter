...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: '/dashboard/affirmations',   label: 'Affirmations',   requires: 'collective' },
  { href: '/dashboard/ecqo-sound',     label: 'ECQO Sound',     requires: 'personalized' },
  { href: '/dashboard/modes',          label: 'Activity Modes', requires: 'personalized' },
  { href: '/dashboard/voice',          label: 'My Voice',       requires: 'personalized' },
  { href: '/dashboard/sessions',       label: 'Live Sessions',  requires: 'elite' },
...
export default function MemberNav({
          ...
          <li key={item.href}>
            <Link
              ...
              style={{
                ...
                color: locked ? 'rgba(26,15,26,0.45)' : 'var(--herr-ink)',
            ...
            >
              <span style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                {item.label}
                {locked && (
                  <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="var(--herr-magenta)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
  ...
  return (
    <>
      ...
      {/* Desktop left rail (hidden md:flex) */}
      <aside
